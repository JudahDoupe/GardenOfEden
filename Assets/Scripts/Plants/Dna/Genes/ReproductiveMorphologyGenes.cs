...
{
    public static void Flower (Plant plant)
    {
    ...
    public static void RingFlower (Plant plant, int flowersPerRing)
    {
    ...
    public static void TallFlower (Plant plant, int numRings, int flowersPerRing)
    {
